...
(* OASIS_START *)
(* DO NOT EDIT (digest: 54b17f6c9db6366e73ed0fb797ecb473) *)
(*
               ...
               Library
                 ({
                     ...
                     },
                   {
                      ...
                      bs_path = "src";
                      bs_compiled_object = Best;
                      bs_build_depends = [FindlibPackage ("cairo2", None)];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
                      bs_ccopt = [(OASISExpr.EBool true, [])];
                     ...
                     },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           InternalLibrary "archimedes_graphics";
                           InternalLibrary "archimedes_cairo"
                        ];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
