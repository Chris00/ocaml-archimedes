...
let () =
  let f s =
    try
      ...
      T.close_path t;
      T.stroke t;
      T.change_coord t (B.Coordinate.create 25. 0. 50. 0. (-25.) 120.);
...
(*Local Variables:*)
(*compile-command: "ocamlopt -o test_tcoord.com dynlink.cmxa color.cmx archimedes.cmxa transform_coord.cmx test_tcoord.ml && ocamlc -o test_tcoord.exe dynlink.cma color.cmo archimedes.cma transform_coord.cmo test_tcoord.ml"*)
(*End:*)
